      ...
      <div className="flex-1 overflow-hidden">
        {showMap ? (
          ...
          <div className="h-full flex">
            ...
            {/* Property Sidebar with cleaner styling */}
            <div className="w-96 bg-white flex flex-col border-l border-gray-200/60 shadow-xl">
              <div className="p-6 border-b border-gray-200/40 bg-gradient-to-r from-gray-50 to-blue-50/30">
