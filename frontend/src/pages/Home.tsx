  ...
  return (
    <div className="min-h-screen">
      ...
      <div className="relative bg-gradient-to-br from-brand-700 via-brand to-brand-900 min-h-screen flex items-center overflow-hidden">
        ...
        <div className="absolute bottom-40 left-20 w-24 h-24 bg-accent/20 rounded-full blur-2xl animate-pulse delay-1000"></div>
        ...
        <div className="container mx-auto px-4 relative z-10">
          <div className="max-w-4xl">
            ...
            <p className="text-xl md:text-2xl text-gray-100 mb-10 max-w-3xl leading-relaxed">
              Detroit has over 30,000 vacant properties. Our AI platform analyzes zoning, foot traffic, 
              and community needs to recommend high-impact opportunities—from cafés to daycares.
            </p>
            <div className="flex flex-col sm:flex-row gap-6">
              <Link
                to="/platform"
                className="group inline-flex items-center px-8 py-4 bg-accent text-brand-900 font-bold rounded-xl hover:bg-accent-light transition-all duration-300 transform hover:scale-105 hover:shadow-2xl shadow-lg"
              >
              ...
              <Link
                to="/about"
                className="group inline-flex items-center px-8 py-4 bg-white/10 backdrop-blur-sm text-white font-semibold rounded-xl hover:bg-white/20 transition-all duration-300 border border-white/20 hover:border-white/40"
              >
                Learn More
          ...
          <div className="bg-white rounded-2xl shadow-2xl p-8 md:p-12">
            <div className="grid grid-cols-1 md:grid-cols-4 gap-8 text-center">
              <div className="group">
                ...
                <div className="text-gray-600 font-medium text-lg">Vacant Properties</div>
              ...
              <div className="group">
                ...
                <div className="text-gray-600 font-medium text-lg">Analysis Accuracy</div>
                <div className="w-12 h-1 bg-accent mx-auto mt-2"></div>
              </div>
              <div className="group">
                <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-brand to-brand-600 bg-clip-text text-transparent mb-3 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="text-gray-600 font-medium text-lg">Investment Potential</div>
                <div className="w-12 h-1 bg-accent mx-auto mt-2"></div>
              </div>
              <div className="group">
                <div className="text-5xl md:text-6xl font-bold bg-gradient-to-r from-brand to-brand-600 bg-clip-text text-transparent mb-3 group-hover:scale-110 transition-transform duration-300">
                ...
                <div className="text-gray-600 font-medium text-lg">Jobs Created</div>
                <div className="w-12 h-1 bg-accent mx-auto mt-2"></div>
              </div>
            </div>
          </div>
      ...
      <div className="py-24 bg-gradient-to-br from-gray-50 to-gray-100">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-brand mb-4">Who We Serve</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Empowering different stakeholders to transform Detroit's urban landscape
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-8">
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold mb-4 text-brand">For Investors</h3>
              ...
              <div className="mt-6 pt-6 border-t border-gray-100">
                <span className="text-sm font-semibold text-accent">→ Smart Investment Decisions</span>
              </div>
            </div>
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold mb-4 text-brand">For Small Businesses</h3>
              <p className="text-gray-600 leading-relaxed">
                Open your dream business with 98% confidence. AI tells you which location will match your goals and maximize profit.
              </p>
              <div className="mt-6 pt-6 border-t border-gray-100">
                <span className="text-sm font-semibold text-accent">→ Perfect Location Match</span>
              </div>
            </div>
            <div className="group bg-white p-8 rounded-2xl shadow-lg hover:shadow-2xl transition-all duration-300 hover:-translate-y-2 border border-gray-100">
              ...
              <h3 className="text-2xl font-bold mb-4 text-brand">For Municipalities</h3>
              <p className="text-gray-600 leading-relaxed">
                Cut vacancy rates and boost tax revenue. AI analyzes projects that increase jobs and community value.
              </p>
              <div className="mt-6 pt-6 border-t border-gray-100">
                <span className="text-sm font-semibold text-accent">→ Community Growth</span>
              </div>
            </div>
          </div>
        </div>
      ...
      <div className="py-24 bg-white">
        <div className="container mx-auto px-4">
          <div className="text-center mb-16">
            <h2 className="text-4xl md:text-5xl font-bold text-brand mb-4">How It Works</h2>
            <p className="text-xl text-gray-600 max-w-2xl mx-auto">
              Three simple steps to transform vacant properties into thriving community assets
            </p>
          </div>
          <div className="grid md:grid-cols-3 gap-12">
            <div className="text-center group">
              ...
              <h3 className="text-2xl font-bold mb-4 text-brand">Select Property</h3>
              <p className="text-gray-600 leading-relaxed max-w-sm mx-auto">
                Choose any vacant property in Detroit or enter an address for instant analysis with our advanced mapping system
              </p>
            </div>
            <div className="text-center group">
              <div className="relative mb-8">
              ...
              <h3 className="text-2xl font-bold mb-4 text-brand">AI Analysis</h3>
              <p className="text-gray-600 leading-relaxed max-w-sm mx-auto">
                Get comprehensive 57-point analysis of property potential, market trends, and community impact in real-time
              </p>
            </div>
            <div className="text-center group">
              <div className="relative mb-8">
              ...
              <h3 className="text-2xl font-bold mb-4 text-brand">Take Action</h3>
              <p className="text-gray-600 leading-relaxed max-w-sm mx-auto">
                Receive detailed recommendations, financial projections, and actionable next steps to move forward
              </p>
            </div>
          </div>
          ...
          <div className="max-w-5xl mx-auto">
            ...
            <div className="text-center mb-16">
              <div className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-accent/20 to-accent/10 rounded-full border border-accent/30 mb-8">
                ...
                <span className="font-bold text-brand">Ready to Make an Impact?</span>
              </div>
              ...
              <p className="text-2xl text-gray-600 mb-12 max-w-4xl mx-auto leading-relaxed">
                Join the movement of investors, entrepreneurs, and community leaders who are 
                <span className="font-bold text-brand"> rebuilding Detroit</span> one property at a time
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8 mb-16">
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-gray-100 overflow-hidden">
                ...
                <div className="relative p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-brand mb-4">Start Analysis</h3>
                  <p className="text-gray-600 mb-6">Get instant AI-powered insights on any Detroit property</p>
                  <div className="text-sm text-accent font-semibold">100% Free • No Signup Required</div>
                </div>
              </div>
              ...
              <div className="group relative bg-gradient-to-br from-accent to-accent-light rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 transform scale-105">
                <div className="relative p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-brand-900 mb-4">AI-Powered</h3>
                  <p className="text-brand-800 mb-6">57-point analysis in under 60 seconds</p>
                  <Link
                    to="/platform"
              ...
              <div className="group relative bg-white rounded-3xl shadow-xl hover:shadow-2xl transition-all duration-500 hover:-translate-y-4 border border-gray-100 overflow-hidden">
                ...
                <div className="relative p-8 text-center">
                  ...
                  <h3 className="text-2xl font-bold text-brand mb-4">Join Community</h3>
                  <p className="text-gray-600 mb-6">Connect with fellow Detroit changemakers</p>
                  <div className="text-sm text-brand font-semibold">500+ Active Members</div>
                </div>
              </div>
            </div>
            ...
            <div className="bg-gradient-to-r from-gray-50 to-gray-100 rounded-3xl p-8 border border-gray-200">
              <div className="text-center mb-6">
                <h4 className="text-2xl font-bold text-brand mb-2">Trusted by Detroit's Best</h4>
                <p className="text-gray-600">Join investors, entrepreneurs, and city planners transforming our city</p>
              </div>
              
              <div className="grid grid-cols-2 md:grid-cols-4 gap-8 text-center">
                <div className="group">
                  <div className="text-3xl mb-2">🏢</div>
                  <div className="text-2xl font-bold text-brand group-hover:scale-110 transition-transform">500+</div>
                  <div className="text-sm text-gray-600">Properties Analyzed</div>
                </div>
                <div className="group">
                  <div className="text-3xl mb-2">⭐</div>
                  <div className="text-2xl font-bold text-brand group-hover:scale-110 transition-transform">4.9/5</div>
                  <div className="text-sm text-gray-600">User Rating</div>
                </div>
                <div className="group">
                  <div className="text-3xl mb-2">🚀</div>
                  <div className="text-2xl font-bold text-brand group-hover:scale-110 transition-transform">50+</div>
                  <div className="text-sm text-gray-600">Businesses Launched</div>
                </div>
                <div className="group">
                  <div className="text-3xl mb-2">💼</div>
                  <div className="text-2xl font-bold text-brand group-hover:scale-110 transition-transform">$2.1B</div>
