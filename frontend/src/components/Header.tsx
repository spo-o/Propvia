                    ...
                    {isAuthenticated && (
                      <>
                        ...
                        <button
                          ...
                          className="flex items-center space-x-2 px-5 py-3 bg-white/5 text-white hover:bg-white/10 rounded-xl transition-all duration-300 border border-transparent hover:border-white/20 backdrop-blur-sm"
                        >
