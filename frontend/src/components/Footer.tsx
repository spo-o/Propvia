        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          ...
          <div className="mb-12 text-center">
            <div className="flex items-center justify-center space-x-3 mb-4">
              <div className="w-12 h-12 bg-gradient-to-br from-accent to-accent-light rounded-2xl flex items-center justify-center shadow-lg">
                <Building2 className="w-7 h-7 text-brand" />
              </div>
              <h2 className="text-3xl font-bold">Propvia</h2>
            </div>
            ...
            <Link
              to="/platform"
              className="inline-flex items-center px-8 py-4 bg-gradient-to-r from-accent to-accent-light text-brand-900 font-bold rounded-xl hover:from-accent-light hover:to-accent transition-all duration-300 transform hover:scale-105 shadow-lg hover:shadow-xl"
            >
              Start Your Analysis
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-8 mb-12">
            <div className="space-y-4">
              <h3 className="text-xl font-bold mb-6 text-accent">About</h3>
              <ul className="space-y-3">
                <li>
                  <Link to="/about" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
                    <span className="group-hover:translate-x-1 transition-transform duration-300">About Us</span>
                  </Link>
                </li>
                <li>
                  <Link to="/contact" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
                    <span className="group-hover:translate-x-1 transition-transform duration-300">Contact</span>
                  </Link>
                </li>
                <li>
                  <Link to="/careers" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
            ...
            <div className="space-y-4">
              ...
              <ul className="space-y-3">
                <li>
                  <Link to="/blog" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
                    <span className="group-hover:translate-x-1 transition-transform duration-300">Blog</span>
                  </Link>
                </li>
                <li>
                  <Link to="/guides" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
                    <span className="group-hover:translate-x-1 transition-transform duration-300">Guides</span>
                  </Link>
                </li>
                <li>
                  <Link to="/faq" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold mb-6 text-accent">Legal</h3>
              <ul className="space-y-3">
                <li>
                  <Link to="/privacy" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
                    <span className="group-hover:translate-x-1 transition-transform duration-300">Privacy Policy</span>
                  </Link>
                </li>
                <li>
                  <Link to="/terms" className="text-white/80 hover:text-accent transition-colors duration-300 flex items-center group">
            ...
            <div className="space-y-4">
              <h3 className="text-xl font-bold mb-6 text-accent">Connect</h3>
              <ul className="space-y-3">
                <li>
                  <a 
              ...
              <div className="mt-6 pt-6 border-t border-white/20">
                <div className="flex items-start space-x-2 text-sm text-white/70 mb-2">
          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-6">
            <div className="flex flex-col md:flex-row justify-between items-center space-y-4 md:space-y-0">
              <div className="text-sm text-white/70">
                ...
                <p className="text-xs mt-1">Built with ❤️ for Detroit's future</p>
              </div>
              ...
              <div className="flex items-center space-x-6">
                ...
                <Link 
                  to="/admin" 
                  className="text-sm text-white/60 hover:text-accent transition-colors duration-300 font-medium"
                >
                  Admin
                </Link>
              </div>
